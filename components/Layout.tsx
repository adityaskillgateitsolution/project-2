        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-1 absolute left-1/2 -translate-x-1/2">
            {NAV_ITEMS.map((item) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold transition-all ${currentPage === item.page
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="lg:hidden w-10 h-10 bg-blue-700 text-white rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30 active:scale-90 transition-all"
