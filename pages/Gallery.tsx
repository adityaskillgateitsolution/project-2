...
const Gallery: React.FC = () => {
  ...
  const images = [
    ...
    { src: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=800&auto=format&fit=crop', title: 'State Level Athletics Meet', category: 'Sports' },
    ...
    { src: 'https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?q=80&w=800&auto=format&fit=crop', title: 'Smart Classroom View', category: 'Infrastructure' },
    ...
    { src: 'https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?q=80&w=800&auto=format&fit=crop', title: 'Library Study Hour', category: 'Academic' },
    { src: 'https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?q=80&w=800&auto=format&fit=crop', title: 'Science Exhibition', category: 'Academic' },
